  ...
  public static function lireUnOuvrage() {
    ...
    foreach($tab_obj as $obj) {
	  ...
	  if (($x+1)==$i){
		...
		$tabAff[] = "<div class='ligne'> <div> <a href=$lien> $t </a>  <img src=$im> <a href=$lien> $t2 </a> <img src=$im2> ";//rajouter des balises div pour la mise en forme
		//$tabAff[] = "<div class='ligne'> <div> $t <img src=$im> $t2 <img src=$im2>";
    ...
    public static function lireLesOuvrages() {
        ...
        foreach($tab_obj as $obj) {
          ...
          if(($x+2)==$i){
            $id3 = $obj->get($identifiant);
            $im3 = $obj->get("lienImageOuvrage");
            $tabAff[] = "<div class='ligne'><div> <a href=$lien>$id</a> <img src=$im> <a href=$lien>$id2</a> <img src=$im2> <a href=$lien>$id3</a> <img src=$im3> ";//rajouter des balises div pour la mise en forme    
            if($a<2){
    ...
    foreach($tab_obj as $obj) {
      $t = $obj->get("titreOuvrage");
      $d = $obj->get("dateParutionOuvrage");
	  $r = $obj->get("resumeOuvrage");
	  $im = $obj->get("lienImageOuvrage");


    $tabAff[] = "<div class='ligne'><div> <img src=$im> <p class:'detailO' > $t , est paru le $d</p> <p class:'detailO' >  Résumé : $r</p>";//rajouter des balises div pour la mise en forme
    }
